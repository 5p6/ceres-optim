...
namespace Mine
{
    ...
    struct MatOptim
    {
        MatOptim(Vec3 _x,Vec2 _y) :x(_x),y(_y) {}
        ...
        static ceres::CostFunction* create(Vec3 x,Vec2 y){
            return new ceres::AutoDiffCostFunction<MatOptim, 2, 4>
    ...
    struct KOptim
    {
        KOptim(Vec3 _x,Vec2 _y) :x(_x),y(_y) {}
        ...
        static ceres::CostFunction* create(Vec3 x,Vec2 y){
            return new ceres::AutoDiffCostFunction<KOptim, 2, 9>
            (new Mine::KOptim(x,y));
        }
    private:
        Vec3 x;
